...
import '@components/organisms/TipTap/tiptap-ui-primitive/toolbar/toolbar.scss';
...
const mergeRefs = <T,>(refs: (React.RefObject<T> | React.Ref<T> | null | undefined)[]): React.RefCallback<T> => {
	return (value) => {
		refs.forEach((ref) => {
