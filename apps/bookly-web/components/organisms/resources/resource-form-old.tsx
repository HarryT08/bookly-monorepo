...
import { createResourceSchema, type CreateResourceFormData } from '../../../services/resources/validation';
		...
		>
			...
			<div>
				<div className="grid grid-cols-1 gap-4 md:grid-cols-2">
					<TextField
						label={i18nResources.building}
						fullWidth
						placeholder={i18nResources.buildingExample}
						{...register('location.building')}
						error={!!errors.location?.building}
						helperText={errors.location?.building?.message as string}
					/>
					<TextField
						label={i18nResources.floor}
						fullWidth
						placeholder={i18nResources.floorExample}
						{...register('location.floor')}
						error={!!errors.location?.floor}
						helperText={errors.location?.floor?.message as string}
					/>
				</div>

				<div className="grid grid-cols-1 gap-4 md:grid-cols-2">
					<TextField
						label={i18nResources.room}
						fullWidth
						placeholder={i18nResources.roomExample}
						{...register('location.room')}
						error={!!errors.location?.room}
						helperText={errors.location?.room?.message as string}
					/>
					<TextField
						label={i18nResources.locationDescription}
						fullWidth
						placeholder={i18nResources.locationDescriptionExample}
