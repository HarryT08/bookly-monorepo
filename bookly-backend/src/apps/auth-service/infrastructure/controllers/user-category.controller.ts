...
export class UserCategoryController {
  ...
  async assignCategoriesToUser(
    ...
    return ResponseUtil.success(await this.commandBus.execute(command), 'Categories assigned to user successfully');
  }
  ...
  async removeCategoriesFromUser(
    ...
    return ResponseUtil.success('Categories removed from user successfully');
  }
  ...
  async getUserCategories(@Param('userId') userId: string) {
    ...
    return ResponseUtil.success(await this.queryBus.execute(query), 'User categories retrieved successfully');
  }
}
