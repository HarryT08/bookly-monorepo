...
// Services
import { NotificationService, NotificationPayload, NotificationResult } from '../services/notification.service';
...
export class NotificationsController {
  ...
  @ApiOperation({
    ...
    description: 'Retrieve a specific template by event type, channel, and language'
  })
  ...
  async testTemplate(
    ...
    const payload: NotificationPayload = {
      ...
      channels: [{ type: NotificationChannelType.EMAIL, enabled: true, priority: NotificationPriority.LOW }],
      metadata: {
        test: true,
        templateId,
        sentBy: user.id
